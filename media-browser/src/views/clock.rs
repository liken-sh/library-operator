...
// shows nothing.
const SIDE: f32 = 360.0;
const HOLDS_TO: f32 = 0.24;
const CLEARS_AT: f32 = 0.5;

// The shade at the corner itself. It is deep, because the surface blends
// in linear space and a light shade over white art reads as pale grey.
// The fade is what keeps the corner from reading as a box.
const SHADE: Color = Color::from_rgba(0.0, 0.0, 0.0, 0.92);
