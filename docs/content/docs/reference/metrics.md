...
The operator serves Prometheus metrics on port 9230, the media browser
on port 9231, and the catalog pod's Corrosion agent on its own
telemetry port, under [liken milestone
